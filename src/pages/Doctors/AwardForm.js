...
class AwardForm extends PureComponent {
    index = 0;
    cacheOriginData = {};
    constructor(props) {
        super(props);
                    ...
                    if (record.editable) {
                        return (
                            <Input
                                value={text}
                                autoFocus
                                // onChange={e => this.props.handleAwardChange(e, 'name', record.key)}
                ...
                render: (text, record) => {
                    if (record.editable) {
                        return (
                            <Input
                                value={text}
                                onChange={e => this.props.handleAwardChange(e, 'workId', record.key)}
                                // onKeyPress={e => this.handleKeyPress(e, record.key)}
